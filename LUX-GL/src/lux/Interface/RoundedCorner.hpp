...
namespace lux {
    ...
    {
    public:
        RoundedCorner(const CornerPosition& cornerPosition, const glm::vec2& xy, float size, const glm::vec4& _color)
            : Mesh(glm::vec3(xy.x, xy.y, 0.0f), glm::vec3(xy.x + size, xy.y + size, 0.0f)), _CornerPosition(cornerPosition) {
            color = _color;
        }
        ...
        void CreateGeometry() override
        {
            ...
            case CornerPosition::TopLeft:
                ...
                break;
            default:
                UX_LOG_ERROR("Corner Position %d Invalid.", _CornerPosition);
                break;
            }
    ...
    private:
        CornerPosition _CornerPosition;
    };
}