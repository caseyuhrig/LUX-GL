...
namespace lux {
    ...
    Skybox::Skybox()
    {
        shader = ux::CreateRef<Shader>("res/shaders/skybox-shader.glsl");
    }
    ...
    void Skybox::Render(const glm::vec3& cameraPosition, const glm::mat4& projection)
    {        
        // draw skybox as last
        ...
        glm::mat4 cameraViewMatrix = glm::lookAt(cameraPosition, cameraPosition + front, up);
